		...
		<div>
			...
			<div className="text-white bg-dark center flex justify-center items-center">
				<div className="max-w-4xl p-8">
					...
					<p>
						At Left4Craft, accessible from https://www.left4craft.org, one of our main priorities is the privacy of our visitors. This Privacy Policy
						document contains types of information that is collected and recorded by Left4Craft and how we use it. Left4Craft is not affiliated with
						Mojang AB.
					</p>
					<br />
					...
					<p>
						...
						they shared and/or collect in Left4Craft. This policy is not applicable to any information collected offline or via channels other than
					...
					<p>
						Left4Craft follows a standard procedure of using log files. These files log visitors when they visit websites. All hosting companies do
					...
					<p>
						Like any other website, Left4Craft uses &apos;cookies&apos;. These cookies are used to store information including visitors&apos;
					...
					<p>
						Left4Craft&apos;s Privacy Policy does not apply to other websites. Thus, we are advising you to consult the respective Privacy Policies of
						these third-party ad servers for more detailed information. It may include their practices and instructions about how to opt-out of
						certain options.{' '}
					</p>
					<br />
					<p>
					...
					<br />
					<p>
						Left4Craft does not knowingly collect any Personal Identifiable Information from children under the age of 13. If you think that your
