		...
		<div className="text-white bg-dark center flex justify-center items-center">
			<div className="max-w-4xl p-8">
				...
				<p>Most interactive websites use cookies to let us retrieve the user&apos;s details for each visit.
					...
					for people visiting our website. Some of our affiliates may also use cookies.</p>

				<div className='text-center text-2xl font-bold p-4'>
					<h1>License</h1>
				</div>

				<p>Unless otherwise stated, Left4Craft and/or its licensors own the intellectual property rights for
					all material on Left4Craft. All intellectual property rights are reserved. You may access this from
					Left4Craft for your own personal use subjected to restrictions set in these terms and conditions.</p>
				<br />
				<p>You must not:</p>
				...
				<p>Parts of this website offer an opportunity for users to post and exchange opinions and information in
					certain areas of the website. Left4Craft does not filter, edit, publish or review Comments prior to
					their presence on the website. Comments do not reflect the views and opinions of Left4Craft,its agents
					and/or affiliates. Comments reflect the views and opinions of the person who post their views and
					opinions. To the extent permitted by applicable laws, Left4Craft shall not be liable for the
				...
				<br />
				<p>Left4Craft reserves the right to monitor all Comments and to remove any Comments which can be considered
				...
				<br />
				<p>You hereby grant Left4Craft a non-exclusive license to use, reproduce, edit and authorize others to use,
				...
				<p>These organizations may link to our home page, to publications or to other Website information so long
					as the link: (a) is not in any way deceptive; (b) does not falsely imply sponsorship, endorsement or approval
					of the linking party and its products and/or services; and (c) fits within the context of the linking party&apos;s site.</p>
				<br />
				...
				<p>We will approve link requests from these organizations if we decide that: (a) the link would not make us look
					...
					Left4Craft; and (d) the link is in the context of general resource information.</p>
				<br />
				...
				<p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our website,
					you must inform us by sending an e-mail to Left4Craft. Please include your name, your organization name, contact
...
>>>>>>> 5ab275a5f140ebb9a2d682bc529356095597351d
			</div>
