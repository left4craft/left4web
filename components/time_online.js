			...
			<div className="max-w-6xl mx-auto px-5 box-content">
				<div className="flex items-center flex-col md:flex-row -mx-5">
					<div className="w-full px-5 mb-5 md:mb-0 text-center md:text-left">
						<h3 className="font-bold font-heading text-xl md:text-2xl text-white">Thanks to your support, Left4Craft has been online for</h3>
					</div>
					<div className="w-full md:w-auto px-5 py-10">
						<div className="flex justify-center text-white text-center">
							<div className="w-20 md:w-24 border border-light-300 bg-light-100 rounded-lg py-3 md:py-4 mx-2">
								<div className="text-2xl md:text-3xl font-semibold">{Math.floor((time - server_founded) / 86400000)}</div>
								<div className="opacity-75 text-xs mt-3 uppercase">{Math.floor((time - server_founded) / 86400000) === 1 ? 'Day' : 'Days'}</div>
							</div>
							<div className="w-20 md:w-24 border border-light-300 bg-light-100 rounded-lg py-3 md:py-4 mx-2">
								<div className="text-2xl md:text-3xl font-semibold">{Math.floor((time - server_founded) / 3600000) % 24}</div>
								<div className=" opacity-75 text-xs mt-3 uppercase">
									{Math.floor((time - server_founded) / 3600000) % 24 === 1 ? 'Hour' : 'Hours'}
								</div>
							</div>
							<div className="w-20 md:w-24 border border-light-300 bg-light-100 rounded-lg py-3 md:py-4 mx-2">
								<div className="text-2xl md:text-3xl font-semibold">{Math.floor((time - server_founded) / 60000) % 60}</div>
								<div className=" opacity-75 text-xs mt-3 uppercase">
									{Math.floor((time - server_founded) / 60000) % 60 === 1 ? 'Minute' : 'Minutes'}
								</div>
							</div>
							<div className="w-20 md:w-24 border border-light-300 bg-light-100 rounded-lg py-3 md:py-4 mx-2">
								<div className="text-2xl md:text-3xl font-semibold">{Math.floor((time - server_founded) / 1000) % 60}</div>
								<div className=" opacity-75 text-xs mt-3 uppercase">
				...
				<div className="mx-auto w-full lg:w-2/5 text-center">
					<h3 className="font-bold font-heading text-lg md:text-xl md:py-0 text-primary py-4">Only want to pay once?</h3>
					<div className="mt-4">
