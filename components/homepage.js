...
export function Homepage(props) {
	...
	const [fadeTextbox, setFadeTextBox] = useState(false);
	...
	return (
		...
		>
			<div className="h-[80vh]">
				<div
					className={`${scroll < 80 ? 'animate-fade-in opacity-100' : 'animate-fade-out opacity-0 cursor-default'} container mx-auto px-6 md:px-12 relative z-10 flex items-center py-32 xl:py-40`}
				>
					<div className="lg:w-4/5 xl:w-3/5 flex flex-col items-start relative z-10">
						...
						>
							<div
								id="l4c-ip-address"
								className="block bg-primary hover:bg-secondary py-3 px-4 rounded-lg text-lg text-white font-bold uppercase mt-10 transition ease-in duration-200"
							>
								mc.left4craft.org
							</div>
							<div className="absolute bottom-0 flex-col items-center mb-6 flex opacity-0 group-hover:opacity-100 transition ease-in duration-500">
								<span className="select-none relative z-10 p-2 text-xs leading-none text-white whitespace-no-wrap bg-black shadow-lg">
									{copyText}
								</span>
			...
			<div
				className={`${scroll > 240 ? 'animate-fade-in opacity-100' : `opacity-0 cursor-default ${fadeTextbox ? 'animate-fade-out' : ''}`} flex flex-wrap justify-center items-center text-center gap-8`}
			>
				<div className="w-full sm:w-1/2 md:w-1/2 lg:w-1/4">
					<div className="relative">
						...
						<div className="absolute top-16 bg-dark px-4 py-6 mt-6 shadow-lg rounded-lg bg-opacity-80">
							<h3 className="text-2xl sm:text-xl font-semibold text-white py-4">Survival</h3>
							<p className="text-md text-gray-300 py-4">
								Semi-vanilla Survival is by far the most popular game-mode. The server features a balanced economy, advanced anti-griefing tools, and
								a vibrant community.
							</p>
						</div>
					</div>
				...
				<div className="w-full sm:w-1/2 md:w-1/2 lg:w-1/4">
					<div className="relative">
						...
						<div className="absolute top-16 bg-dark px-4 py-6 mt-6 shadow-lg rounded-lg bg-opacity-80">
							<h3 className="text-2xl sm:text-xl font-semibold text-white py-4">Creative</h3>
							<p className="text-md text-gray-300 py-4">
								Left4Craft&apos;s creative server offers large plots and free worldedit. Years of builds have accumulated to provide plenty of
								inspiration.
							</p>
						</div>
					</div>
				...
				<div className="w-full sm:w-1/2 md:w-1/2 lg:w-1/4">
					<div className="relative">
						...
						<div className="absolute top-16 bg-dark px-4 py-6 mt-6 shadow-lg rounded-lg bg-opacity-80">
							<h3 className="text-2xl sm:text-xl font-semibold text-white py-4">Party Games</h3>
							<p className="text-md text-gray-300 py-4">
								Party Games is a completely custom gamemode designed for 4-8 players. Over a dozen unique minigames provide hours of fast-paced fun.
							</p>
						</div>
					</div>
				</div>
			...
			>
				<div className="w-full sm:w-1/2 md:w-1/2 lg:w-1/4">
					<div className="relative">
						...
						<div className="absolute top-16 bg-dark px-4 py-6 mt-6 shadow-lg rounded-lg bg-opacity-80">
							<h3 className="text-2xl sm:text-xl font-semibold text-white py-4">Since 2013</h3>
							<p className="text-md text-gray-300 py-4">
								Left4Craft has been operated continuously since 2013 and will continue to operate for years to come. You can rest assured this
				...
				<div className="w-full sm:w-1/2 md:w-1/2 lg:w-1/4">
					<div className="relative">
						...
						<div className="absolute top-16 bg-dark px-4 py-6 mt-6 shadow-lg rounded-lg bg-opacity-80">
							<h3 className="text-2xl sm:text-xl font-semibold text-white py-4">Custom Code</h3>
							<p className="text-md text-gray-300 py-4">
								A lot of the code, including this website, is completely custom written and open source. You can read it on the{' '}
								<a target="_blank" rel="noreferrer" className="underline" href="https://github.com/left4craft">
									official Left4Craft Github
								</a>
								.
							</p>
						</div>
				...
				<div className="w-full sm:w-1/2 md:w-1/2 lg:w-1/4">
					<div className="relative">
						...
						<div className="absolute top-16 bg-dark px-4 py-6 mt-6 shadow-lg rounded-lg bg-opacity-80">
							<h3 className="text-2xl sm:text-xl font-semibold text-white py-4">Blazing Fast</h3>
							<p className="text-md text-gray-300 py-4">
								Left4Craft utilizes modern hardware and networking topology to deliver high TPS and low latency. We even publish performance metrics
								on our{' '}
								<a target="_blank" rel="noreferrer" className="underline" href="https://status.left4craft.org">
									status page
								</a>
								.
							</p>
			...
			<div className="container mx-auto px-6 md:px-12 relative z-10 flex items-center">
				<div className="lg:flex lg:items-center lg:justify-between w-full mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8 z-20">
					<h2 className="text-3xl font-extrabold text-white sm:text-4xl drop-shadow-lg">
						<span className="block">Ready to join Left4Craft?</span>
					</h2>
					<div className="lg:mt-0 lg:flex-shrink-0 py-8">
						...
						<div className="px-5 inline-flex rounded-md">
							<div className="cursor-pointer">
								<Link href="https://discord.left4craft.org" className="relative flex flex-col items-center group" passHref legacyBehavior>
									<div
										id="l4c-discord"
										className="bg-dark hover:bg-light py-3 px-4 rounded-lg text-lg text-white font-bold uppercase mt-10 transition ease-in duration-200 flex items-center gap-1"
									>
										<FaDiscord />
										Discord
									</div>
