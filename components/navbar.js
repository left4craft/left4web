			...
			<nav className={'select-none bg-dark shadow' + (props.fixed ? ' fixed w-full' : 'absolute w-full')}>
						...
						<div className="flex items-center">
							...
							<div className="hidden md:block">
								<div className="ml-10 flex items-baseline space-x-4">
									...
									<Link href="/punishments" className="text-gray-300 hover:text-white px-3 py-2 rounded-md text-sm font-medium">
										Bans
									</Link>
				...
				<div className="md:hidden" hidden={!isOpen}>
					<div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
						...
						<Link href="/vote" className="text-gray-300 hover:text-white block px-3 py-2 rounded-md text-base font-medium">
							Vote
						</Link>
						<Link href="/punishments" className="text-gray-300 hover:text-white block px-3 py-2 rounded-md text-base font-medium">
							Bans
						</Link>
